### Using the Python language, have the function ArithGeo(arr) take the array of numbers stored 
...
### either pattern return -1. An arithmetic sequence is one where the difference between 
### each of the numbers is consistent, where as in a geometric sequence, each term after 
